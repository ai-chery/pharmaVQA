...
sys.path.append('../')
from DTA.graph_trans_model import TransformerNodeEncoder_v3, TransformerNodeDecoder
from DTA.encoder import PosEncoder
from DTA.loader_relmole import FG_NUM, fg2tensor
from DTA.loader_ecfp import ECFP_DIM, ecfp2tensor
